...
const stats = [
  {
    ...
    icon: FolderOpenIcon,
    gradient:
      "from-blue-500/10 to-blue-600/5 dark:from-blue-500/15 dark:to-blue-600/5",
  ...
  },
  {
    ...
    icon: SourceCodeIcon,
    gradient:
      "from-violet-500/10 to-violet-600/5 dark:from-violet-500/15 dark:to-violet-600/5",
  ...
  },
  {
    ...
    icon: CodeIcon,
    gradient:
      "from-emerald-500/10 to-emerald-600/5 dark:from-emerald-500/15 dark:to-emerald-600/5",
  ...
  },
  {
    ...
    icon: ApiIcon,
    gradient:
      "from-amber-500/10 to-amber-600/5 dark:from-amber-500/15 dark:to-amber-600/5",
