...
const methodColors: Record<string, string> = {
  ...
  PATCH: "bg-orange-100 text-orange-700 dark:bg-orange-950 dark:text-orange-400",
...
export function HttpMethodBadge({ method, className }: HttpMethodBadgeProps) {
  return (
    <span
      className={cn(
        "inline-flex items-center rounded px-2 py-0.5 text-xs font-semibold font-mono",
